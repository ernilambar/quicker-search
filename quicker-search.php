...
define( 'QUICKER_SEARCH_VERSION', '1.0.6' );
...
// Updater.
$qs_update_checker = \YahnisElsts\PluginUpdateChecker\v5\PucFactory::buildUpdateChecker( 'https://github.com/ernilambar/quicker-search', __FILE__, QUICKER_SEARCH_SLUG );
$qs_update_checker->getVcsApi()->enableReleaseAssets();
